  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
      <div className="mx-auto max-w-xl text-center">
        ...
        {/* Nouvelle section pour les études psychédéliques */}
        <div className="mt-24">
          <p className="text-2xl font-semibold tracking-tight text-balance text-gray-900 sm:text-2xl">
            {t('psychedelicStudies')}
          </p>
          <p className="mt-12 text-lg/8 font-medium font-mono bg-clip-text text-transparent bg-gradient-to-r from-sky-500 via-pink-500 to-yellow-500">
            <span>recherchepsyche</span>
            <span className="mx-2">@</span>
            <span>ghu-paris.fr</span>
          </p>
        </div>
